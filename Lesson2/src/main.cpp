...
int main(void) {
	...
	/* Create vertex buffer objects - one for points and one for colors */
	...
	glBindBuffer(GL_ARRAY_BUFFER, colors_vbo);
	glVertexAttribPointer(1, 3, GL_FLOAT, GL_FALSE, 0, NULL); // Assign index 1 the colors
	...
	/* Bind input variables to attribute location */
